...
const research = tree.addTaskToTaskId("Market research", "pending", root)
tree.addTaskToTaskId("Identify target audience", "pending", research)
tree.addTaskToTaskId("Analyze competitors", "pending", research)
tree.addTaskToTaskId("Define value proposition", "pending", research)

const product = tree.addTaskToTaskId("Finalize product", "pending", root)
const features = tree.addTaskToTaskId("Lock features", "pending", product)
tree.addTaskToTaskId("Core functionality", "pending", features)
tree.addTaskToTaskId("Edge cases", "pending", features)
tree.addTaskToTaskId("Performance constraints", "pending", features)

const qa = tree.addTaskToTaskId("Quality assurance", "pending", product)
tree.addTaskToTaskId("Unit tests", "pending", qa)
tree.addTaskToTaskId("Integration tests", "pending", qa)
tree.addTaskToTaskId("Regression tests", "pending", qa)

const marketing = tree.addTaskToTaskId("Marketing rollout", "pending", root)
const content = tree.addTaskToTaskId("Content creation", "pending", marketing)
tree.addTaskToTaskId("Landing page copy", "pending", content)
tree.addTaskToTaskId("Email campaign", "pending", content)
tree.addTaskToTaskId("Social media posts", "pending", content)

const ops = tree.addTaskToTaskId("Operations", "pending", root)
tree.addTaskToTaskId("Deployment plan", "pending", ops)
tree.addTaskToTaskId("Monitoring setup", "pending", ops)
tree.addTaskToTaskId("Rollback strategy", "pending", ops)
